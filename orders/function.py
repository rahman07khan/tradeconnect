...
def send_amount_to_seller(payment, order_tracking):
    ...
    return_window_days = products.product.return_window_days
...
def calculate_return_date(order_tracking):
    products = order_tracking.order.checkout.first() 
    print(products)
    return_window_days = products.product.return_window_days
    print(return_window_days)
    return_date = order_tracking.updated_at + timedelta(days=return_window_days)
    print(return_date)
    return return_date
